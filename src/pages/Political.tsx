              ...
              <div className="flex items-center animate-scroll whitespace-nowrap w-max">
                {[...Array(2)].map((_, setIndex) => (
                  <div key={setIndex} className="flex gap-10 md:gap-20 items-center px-4">
                    <img loading="lazy" src={bjpLogo} alt="BJP" className="h-32 w-32 md:h-48 md:w-48 object-contain hover:scale-110 transition-transform rounded-full" />
                    <img loading="lazy" src={congressLogo} alt="Congress" className="h-32 w-32 md:h-48 md:w-48 object-contain hover:scale-110 transition-transform rounded-full" />
                    <img loading="lazy" src={shivSenaLogo} alt="Shiv Sena (UBT)" className="h-32 w-32 md:h-48 md:w-48 object-contain hover:scale-110 transition-transform" />
                    <img loading="lazy" src={shivSenaBowLogo} alt="Shiv Sena" className="h-32 w-32 md:h-48 md:w-48 object-contain hover:scale-110 transition-transform rounded-full" />
